...
fn managed_uv_dir(app: &tauri::AppHandle) -> Result<PathBuf, String> {
...
pub(crate) fn whisper_env_ready(app: &tauri::AppHandle) -> bool {
...
pub(crate) fn managed_python(app: &tauri::AppHandle) -> Result<PathBuf, String> {
...
fn ensure_uv(app: &tauri::AppHandle) -> Result<PathBuf, String> {
...
fn download_uv(app: &tauri::AppHandle) -> Result<PathBuf, String> {
    #[cfg(windows)]
    {
        let _ = app;
        return Err(
...
pub(crate) fn ensure_whisper_env(app: &tauri::AppHandle) -> Result<PathBuf, String> {
