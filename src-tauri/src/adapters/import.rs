...
pub(crate) struct AppleImportScan {
...
pub(crate) enum AppleImportMode {
    Preserve,
    Flatten,
}
...
#[derive(Deserialize)]
pub(crate) struct AppleImportArgs {
    pub(crate) source_path: String,
    pub(crate) mode: AppleImportMode,
...
pub(crate) struct AppleImportState {
...
pub(crate) fn apple_import_snapshot() -> AppleImportState {
    import_state()
        .lock()
...
pub(crate) fn begin_apple_import(target_folder: String) -> Result<(), String> {
...
pub(crate) fn scan_apple_import_source(source: &Path) -> Result<AppleImportScan, String> {
...
pub(crate) fn run_apple_notes_import(notes_root: PathBuf, args: AppleImportArgs) {
