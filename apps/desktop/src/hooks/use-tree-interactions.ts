...
import { findNode } from "@/lib/notes/tree-ops";
import { focusNoScroll } from "@/lib/dom";
import { getNoteParentPath } from "@typenotes/shared/notes";
import { computeRangeSelection, resolveTargetPaths } from "@/lib/selection";
...
export type TreeInteractions = {
  ...
  desktopContextMenuState: ContextMenuState | null;
